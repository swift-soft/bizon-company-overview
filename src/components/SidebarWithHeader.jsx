...
const LinkItems = [
  ...
  { name: "Recruitment", icon: FiUser, path: "/" },
  { name: "Payroll", icon: FiCreditCard, path: "/" },
  { name: "Scheduler", icon: FiCalendar, path: "/" },
  { name: "Forms Manager", icon: FiFileText, path: "/" },
  { name: "Integration", icon: FiGitPullRequest, path: "/" },
  { name: "Reports", icon: FiBarChart2, path: "/" },
  { name: "Templates", icon: FiFolder, path: "/" },
  { name: "Employee wellbeing", icon: FiHeart, path: "/employee-wellbeing" },
